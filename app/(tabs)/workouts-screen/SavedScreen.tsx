...
import { SavedMenuModal } from './SavedMenuModal';
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.menuModalContent}>
            <TouchableOpacity 
              ...
              <Text style={styles.closeXText}>Ã¢Å“â€¢</Text>
            </TouchableOpacity>
            ...
            {editingWorkout?.exercises.map(exerciseId => (
              <View key={exerciseId} style={styles.editExerciseItem}>
                ...
                <TouchableOpacity 
                  ...
                  <Text style={styles.removeExerciseText}>Ã¢Ë†â€™</Text>
                </TouchableOpacity>
              </View>
            ))}
          </ScrollView>
                ...
                renderItem={({ item }) => {
                  ...
                  return (
                    <Pressable
                      ...
                      {item.isSaved && (
                        <Text style={styles.savedBadge}>Ã¢Ëœâ€¦</Text>
                      )}
                    </Pressable>
                  );
                }}
              ...
              {detailExercise?.instructions ? (
                <TouchableOpacity
                  ...
                  <View style={styles.instructionsHeaderRow}>
                    ...
                    <Text style={styles.instructionsChevron}>{isDetailInstructionsExpanded ? 'Ã¢â€“Â´' : 'Ã¢â€“Â¾'}</Text>
                  </View>
                  <Text
